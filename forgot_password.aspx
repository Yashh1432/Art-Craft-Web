<%@ Page Title="" Language="C#" MasterPageFile="~/client.master" AutoEventWireup="true" CodeFile="forgot_password.aspx.cs" Inherits="forgot_password" %>
        ...
        <div class="row align-items-center">
            ...
            <div class="input-group mb-3 pb-5">
                ...
                <asp:TextBox runat="server" ID="txtpassword" TextMode="Password" CssClass="form-control form-control-lg bg-light fs-6" placeholder="Enter new Password"></asp:TextBox>
                  ...
                  <div class="input-group mb-3 pb-5">
                       <asp:Label runat="server"  ID="lblconfpass" for="your_pass"><i class="zmdi zmdi-lock pr-5 material-icons-name" style="font-size: 3.2rem;"></i></asp:Label><br/>
                      <asp:TextBox runat="server" ID="txtconfpassword" TextMode="Password" CssClass="form-control form-control-lg bg-light fs-6" placeholder="Re-Enter New Password"></asp:TextBox>
                  </div>
            ...
            <div class="input-group mb-3">
                <asp:Button runat="server" ID="btnverify"  Text="Change"  OnClick="btnverify_Click" CssClass="btn btn-lg btn-primary w-100 fs-6" Width="90px" Font-Size="Medium" BackColor="Black" Font-Bold="True"/>
            </div>
            <div class="input-group mb-3">
            ...
            <div class="row">
                <big>want to go back? <a href="forgotpass.aspx">Back</a></big>
